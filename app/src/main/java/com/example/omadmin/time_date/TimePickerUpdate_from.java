...
public  class TimePickerUpdate_from  extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public void onTimeSet(TimePicker timePicker, int i, int i1) {
        ...
        UpdateRestaurantProfile.time_from_int=i+":"+i1;
        ...
        if(i>12 && i<24){
            ...
            UpdateRestaurantProfile.tv_from.setText(iStr+":"+i1Str+" Pm");
            ...
            UpdateRestaurantProfile.tv_from.setText(result+":"+i1Str+" Pm");
            ...
            UpdateRestaurantProfile.tv_from.setText(iStr+":"+i1Str+" Am");
